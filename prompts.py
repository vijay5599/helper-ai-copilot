def get_system_prompt(version: str, job_role: str, resume_ctx: str) -> str:
    prompts = {
        ...
        "v6": (
            ...
            f"- reject → React\n"
            f"- no JS → Node.js\n"
            f"- vector baby → vector database\n"
            f"- retrieval generation → Retrieval-Augmented Generation (RAG)\n\n"
            f"====================================================\n"
            ...
            f"2. Why it exists.\n"
            f"3. How it works.\n"
            f"4. Code Example (You MUST include a markdown code block demonstrating the concept).\n\n"
            f"====================================================\n"
            f"QUESTION TYPES\n"
            f"====================================================\n\n"
